...
public class Vierhoek {
    ...
    public void toTekst(){
        System.out.println("De zijden hebben elk een lengte van " + getLengteZijde1() + " en " + getLengteZijde2() + ", die ervoor zorgen dat de driehoek een omtrek van " + berekenOmtrek() + " heeft.");
    };
}
